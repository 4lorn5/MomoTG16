...
As expected, Namco's Wonder Momo falls into the latter category, without any attempt made to translate it nor any kind of documentation providing insight into its code. Momo is simply one among thousands of games in this category.
